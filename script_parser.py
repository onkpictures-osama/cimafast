...
# الحرف الواحد م آمن من غير شرطة لأن أول حرف بعده لازم يكون فاصل أو رقم،
# فكلمات زي مصر/من/مدة مش بتتلقط. وبندعم كمان SCENE الإنجليزي و"مشهد رقم".
SCENE_HEADER_RE = re.compile(
    r'^\s*(?:مشهد|المشهد|سين|السين|SCENE|SC|م)\s*(?:رقم\s*)?[:\-–—/.]?\s*(\d+)', re.IGNORECASE)
