"""البروفايل العام للممثل (مشاركة على السوشيال ميديا) — public_profile.py.

    venv/bin/python tests/test_public_profile.py

بيقفل: كل عمود في جدول actors متصنّف صراحةً (عام / باختيار الممثل / خاص)،
...
def _leaky_actor(owner=A):
    ...
    # الممثل مختار التليفون والوزن "ظاهرين للكل" جوه المنصة — ده مايخليهمش
