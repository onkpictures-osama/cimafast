...
def _labels():
    return {k: t(v) for k, v in {
        ...
        "room": "مقاس المكان:", "place": "حط في الرسمة:", "nothing_to_place": "مفيش شخصيات مربوطة بالمشهد ولا لقطات لسه.",
        ...
        "hint_block": "اسحب الشخصيات والكاميرات. السهم الصغير = الشخصية باصّة فين، والمثلث = اللي الكاميرا شايفاه.",
    }.items()}
