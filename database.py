...
_MIGRATIONS = {
    # 👤 حسابي (المالك 2026-09-26): مين من المشغّلين عمل الحساب ده - عشان يلاقيه
    # في قايمة «الحسابات اللي عملتها» ويقدر يطلّع له كلمة سر مؤقتة جديدة.
    "users": [
        ("created_by", "TEXT"),
        # 🛡️ إدارة الحسابات (المالك 2026-09-26): مزايا مقفولة (JSON list)، حد أسئلة
        # المساعد، تاريخ انتهاء الحساب، ملاحظة داخلية، ولو اتدمج في حساب تاني.
