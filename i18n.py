...
TRANSLATIONS = {
    ...
    # 🛡️ إدارة الحسابات (2026-09-26)
    'آخر نشاط': 'Recent activity',
    'أسئلة للمساعد': 'Assistant questions',
    'أوقف الحساب': 'Suspend account',
    'إدارة الحسابات': 'Account management',
    'إدارة كل الحسابات': 'Manage all accounts',
    'إيقاف، تعديل، قفل مزايا، نقل ملفات، دمج، وحذف': 'Suspend, edit, lock features, transfer files, merge and delete',
    'إضافة ناس لفريق المشروع': 'Adding people to a project crew',
    'إنشاء مشاريع جديدة': 'Creating new projects',
    'اتحذف': 'Deleted',
    'اتحفظت بيانات': 'Saved details of',
    'اتحفظت مزايا': 'Saved features of',
    'اتدمج في': 'Merged into',
    'اتعمل': 'Created',
    'اتنقل': 'Transferred',
    'احذف الحساب نهائيًا': 'Delete account permanently',
    'اختار حساب من الجدول (المربع جنب الصف) عشان تديره.': 'Pick an account in the table (box beside the row) to manage it.',
    'ادمج': 'Merge',
    'ادمجه في حساب تاني': 'Merge into another account',
    'اسم أو اسم دخول…': 'Name or username…',
    'اسم الحساب الجديد': 'New account name',
    'اسم الدخول الجديد (إنجليزي)': 'New username (English)',
    'اكتب اسم الدخول للتأكيد': 'Type the username to confirm',
    'الإيميل': 'Email',
    'الاسم': 'Name',
    'البيانات': 'Details',
    'الحذف نهائي: الحساب بيتمسح وعضوياته، ومساحة عمله بتتقفل. بتتاخد نسخة احتياطية من قاعدة البيانات قبلها.': 'Deletion is permanent: the account and its memberships are removed and its workspace is closed. A database backup is taken first.',
    'الحساب اتوقف': 'Account suspended',
    'الحساب اشتغل تاني': 'Account reactivated',
    'الحساب الموجود': 'Existing account',
    'الحساب شغال لحد (فاضي = على طول)': 'Account active until (empty = no end)',
    'الحسابات': 'Accounts',
    'الصفحة دي لمشغّل المنصة بس.': 'This page is for platform operators only.',
    'المزايا': 'Features',
    'المشروع': 'Project',
    'الميزة دي مقفولة على حسابك — كلّم إدارة البرنامج لو محتاجها.': 'This feature is locked on your account — contact the platform team if you need it.',
    'النشاط': 'Activity',
    'النوع': 'Type',
    'الوصول والمزايا': 'Access & features',
    'الوظيفة': 'Job title',
    'الوقت': 'Time',
    'امسح مشاريعه كمان': 'Delete their projects too',
    'انقل': 'Transfer',
    'انقل ملفاته لحساب تاني': 'Transfer their files to another account',
    'بتظهر مرة واحدة، وهيطلب منه يغيّرها أول ما يدخل:': 'shown once; they must change it at first login:',
    'تحليل السيناريو بالذكاء الاصطناعي': 'AI script analysis',
    'تصدير التقارير (Excel / Word / PDF)': 'Report exports (Excel / Word / PDF)',
    'تقرير البناء الدرامي': 'Dramatic-structure report',
    'حد أسئلة المساعد في اليوم (فاضي = 40)': 'Assistant questions per day (empty = 40)',
    'حساب': 'accounts',
    'حساب جديد': 'New account',
    'حساب موجود': 'Existing account',
    'حفظ المزايا': 'Save features',
    'دخلوا آخر ٧ أيام': 'Logged in, last 7 days',
    'ده حساب مشغّل — مايتعدّلش من هنا.': "This is an operator account — it can't be changed here.",
    'دوّر': 'Search',
    'سأل المساعد': 'Asked the assistant',
    'شخصيات': 'Characters',
    'شغالة': 'Active',
    'شغّل الحساب تاني': 'Reactivate account',
    'شيل العلامة عشان تقفل الميزة على الحساب ده:': 'Untick to lock a feature for this account:',
    'علّم «متأكد» واختار الحساب الأول': 'Tick “sure” and pick the account first',
    'عمل إيه': 'What',
    'عمله': 'Created by',
    'عنده': 'Has',
    'كل ملفاته وعضوياته في مشاريع الناس بتروح للحساب التاني، والحساب ده بيتقفل (بيفضل في السجل).': 'All their files and project memberships move to the other account, and this one is closed (kept in the log).',
    'كلمة السر المؤقتة لـ': 'Temporary password for',
    'كلمة سر الحساب الجديد': "New account's password",
    'لسه مفيش نشاط.': 'No activity yet.',
    'لمين؟': 'To whom?',
    'ماداخلش ولا مرة': 'Never logged in',
    'ماداخلوش ولا مرة': 'Never logged in',
    'متأكد — الحساب ده هيتقفل بعد الدمج': 'Sure — this account will be closed after merging',
    'مش هيقدر يدخل، ولو فاتح البرنامج هيطلع مع أول ضغطة. ملفاته زي ما هي.': "They can't log in; an open session ends at the next click. Their files stay.",
    'مشاريع': 'Projects',
    'مشاريعه': 'Their projects',
    'مشروع': 'project(s)',
    'مشروع — انقلهم من «نقل ودمج» الأول، أو امسحهم معاه:': 'project(s) — transfer them first, or delete them with the account:',
    'مشغّل': 'Operator',
    'مكان حقيقي': 'real venue(s)',
    'ملاحظة داخلية (مابتظهرش له)': 'Internal note (not shown to them)',
    'ملفاته': 'Their files',
    'ممثل': 'actor(s)',
    'موقوفة / خلصت': 'Suspended / expired',
    'نقل ودمج': 'Transfer & merge',
    'يدمج في': 'Merge into',
    'يفضل عضو في مشاريعه بعد النقل (يعدّل)': 'Keep them on their projects after the transfer (can edit)',
    '🤖 ارسمها لي (رسمة المكان)': '🤖 Draw it for me (location plan)',
    '🤖 المساعد': '🤖 Assistant',
    'مقفول على حسابك': 'Locked on your account',
    '🟢 شغال': '🟢 Active',
    '⏸️ موقوف': '⏸️ Suspended',
    '⌛ مدته خلصت': '⌛ Expired',
    '🔗 اتدمج': '🔗 Merged',
    'أو اختار الحساب': 'Or pick the account',
    'اكتب أو اختار…': 'Type or pick…',
    'اختار حساب من الجدول (المربع جنب الصف) أو من القايمة عشان تديره.': 'Pick an account in the table or the list to manage it.',
}
