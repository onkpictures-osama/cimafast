...
TRANSLATIONS = {
    ...
    # ما بعد الإنتاج وشريط التقدّم حسب المرحلة (2026-09-24)
    'المونتاج': 'Editing',
    'المؤثرات البصرية (CGI)': 'Visual effects (CGI)',
    'التلوين (Color)': 'Color grading',
    'الموسيقى': 'Music',
    'تصميم الصوت': 'Sound design',
    'الدوبلاج والميكساج': 'ADR & mix',
    'التترات والجرافيك والماستر': 'Titles, graphics & master',
    'لم يبدأ': 'Not started',
    'جاري': 'In progress',
    'في المراجعة': 'In review',
    'محتاج تعديل': 'Needs changes',
    'معتمد': 'Approved',
    'ما بعد الإنتاج': 'Post-production',
    'قسم معتمد': 'departments approved',
    'قسم ماتحدّثش من أسبوع': 'department(s) not updated for a week',
    'ماتحدّثش من أسبوع': 'not updated for a week',
    'نسبة الإنجاز': 'Completion',
    '«معتمد» بيتحسب 100% و«لم يبدأ» 0% مهما كانت النسبة هنا.': '“Approved” counts as 100% and “Not started” as 0%, whatever the slider says.',
    'الاستوديو / المسؤول': 'Studio / person in charge',
    'التواصل (تليفون / إيميل)': 'Contact (phone / email)',
    'لينك معاينة': 'Preview link',
    'لينك معاينة تاني': 'Second preview link',
    'ميعاد التسليم': 'Delivery date',
    'ملاحظات': 'Notes',
    'حفظ': 'Save',
    'اتحفظ': 'Saved',
    'معاينة': 'Preview',
    ...
    'الإنجاز الكلي': 'Overall completion',
    'أقسام معتمدة': 'Approved departments',
    'ماتحدّثتش من أسبوع': 'Not updated for a week',
    'تقرير ما بعد الإنتاج (Excel)': 'Post-production report (Excel)',
    'التصوير لسه مابدأش': "Shooting hasn't started",
    'مفيش أيام تصوير — اعمل الأيام من «افتح جدول التصوير»': 'No shooting days yet — create them from “Open shooting schedule”',
    'التصوير': 'Shooting',
    'مشهد اتصور': 'scenes shot',
    'أيام اتصورت': 'Days shot',
    'علّم على اليوم أول ما يخلص تصويره.': 'Tick a day as soon as its shoot wraps.',
    # طاولة التقطيع (2026-09-25)
    'طاولة التقطيع': 'Cutting table (découpage)',
    'نص المشهد': 'Scene text',
    'الرسمة من فوق': 'Top-view plan',
    'الكل': 'All',
    'الحوار بس': 'Dialogue only',
    'الوصف بس': 'Action only',
    'لقطة جديدة': 'New shot',
    'تغطية لقطة': 'Coverage of shot',
    '➕ لقطة من المختار': '➕ Shot from selection',
    '💾 احفظ التغطية': '💾 Save coverage',
    'إلغاء الاختيار': 'Clear selection',
    'المشهد ده مالوش نص محفوظ.': 'This scene has no saved text.',
    'دوس على الجمل وسطور الحوار اللي اللقطة هتغطيها، وبعدين «لقطة من المختار». الخطوط الملوّنة جنب النص = اللقطات اللي بتغطيه.': 'Click the sentences and dialogue lines the shot covers, then “Shot from selection”. Coloured lines beside the text are the shots covering it.',
    '🎭 الشخصيات والكاميرات': '🎭 Characters & cameras',
    '🏠 الديكور': '🏠 Set',
    '💾 احفظ الرسمة': '💾 Save plan',
    '● فيه تعديل لسه ماتحفظش': '● Unsaved changes',
    '✏️ كروكي بالإيد': '✏️ Freehand sketch',
    '↶ امسح آخر خط': '↶ Undo last line',
    'مقاس المكان:': 'Space size:',
    'حط في الرسمة:': 'Place on plan:',
    'مفيش شخصيات مربوطة بالمشهد ولا لقطات لسه.': 'No characters linked to this scene and no shots yet.',
    '↝ حركة': '↝ Movement',
    '🗑️ شيل': '🗑️ Remove',
    'قطعة': 'Piece',
    'اسحب القطع لمكانها، ودوس على قطعة عشان تلفّها أو تكبّرها أو تسمّيها. «كروكي» = ارسم بإيدك.': 'Drag pieces into place; click one to rotate, resize or name it. “Sketch” = draw by hand.',
    'اسحب الشخصيات والكاميرات. السهم الصغير = الشخصية باصّة فين، والمثلث = اللي الكاميرا شايفاه.': 'Drag characters and cameras. The small arrow is where a character faces; the triangle is what the camera sees.',
    'باب': 'Door',
    'شباك': 'Window',
    'حيطة': 'Wall',
    'ترابيزة': 'Table',
    ...
    'سرير': 'Bed',
    'مكتب': 'Desk',
    'بار / كاونتر': 'Bar / counter',
    'دولاب': 'Cabinet',
    'زرع': 'Plant',
    'عربية': 'Car',
    'المشهد ده مالوش مكان — حدد مكانه في تبويب المشاهد عشان رسمة الديكور تتحفظ للمكان.': 'This scene has no location — set it in the Scenes tab so the set plan is saved for the location.',
    'لسه مفيش رسمة للمكان ده. ارسمها بإيدك من «الديكور»، أو خلّي الذكاء الاصطناعي يرسمها ليك.': 'No plan for this location yet. Draw it under “Set”, or let AI draw it for you.',
    'رسمها الذكاء الاصطناعي — عدّلها براحتك': 'drawn by AI — edit freely',
    'الرسمة الافتراضية للمكان': "The location's default plan",
    'بتتطبق على كل حالاته': 'applies to all its states',
    'رسمة خاصة بالحالة دي': 'A plan for this state only',
    'تعديل الديكور يتحفظ على:': 'Save set changes to:',
    'الرسمة الافتراضية (كل حالات المكان)': 'Default plan (all states)',
    'الحالة دي بس': 'This state only',
    'رجّع الحالة دي للرسمة الافتراضية': 'Return this state to the default plan',
    'الذكاء الاصطناعي بيرسم المكان… الصفحة هتتحدّث لوحدها.': 'AI is drawing the location… the page will refresh by itself.',
    'الرسمة وصلت — عدّلها براحتك': 'The plan arrived — edit freely',
    'الرسمة اللي رجعت مش سليمة': 'The returned plan is not valid',
    'الذكاء الاصطناعي ماعرفش يرسم المكان': 'AI could not draw the location',
    'ارسمها لي': 'Draw it for me',
    'ارسمها لي من جديد (بتستبدل الرسمة الافتراضية)': 'Draw it again (replaces the default plan)',
    'فورم «لقطة جديدة» تحت اتعبّى بالنص اللي اخترته — كمّل الحجم والزاوية والحركة واحفظ.': 'The “New shot” form below is filled with your selection — set size, angle and movement, then save.',
    'اتحفظت تغطية اللقطة': 'Shot coverage saved',
    'اتحفظت الرسمة': 'Plan saved',
    'مقدرناش نرسم المكان المرة دي. جرّب تاني بعد شوية، أو ارسمه بإيدك.': "We couldn't draw the location this time. Try again shortly, or draw it by hand.",
    # 👤 حسابي (2026-09-26)
    'حسابي': 'My account',
    'اسم الدخول': 'Username',
    'غيّر كلمة السر': 'Change password',
    'كلمة السر الحالية': 'Current password',
    'كلمة السر الجديدة (١٠ حروف على الأقل)': 'New password (at least 10 characters)',
    'أعد كتابتها': 'Repeat it',
    'حفظ كلمة السر': 'Save password',
    'الكلمتين مش زي بعض': 'The two passwords differ',
    'اتغيّرت كلمة السر': 'Password changed',
    'أهلًا': 'Hi',
    'ده حسابك على سيما فاست ستوديو:': 'Here is your CimaFast Studio account:',
    'الرابط': 'Link',
    'كلمة السر المؤقتة': 'Temporary password',
    'أول ما تدخل البرنامج هيطلب منك تختار كلمة سر جديدة.': "When you first log in you'll be asked to choose a new password.",
    'الحساب جاهز': 'Account ready',
    'كلمة سر مؤقتة جديدة': 'New temporary password',
    'كلمة السر دي بتظهر هنا مرة واحدة بس. أول ما يدخل هيطلب منه يغيّرها بكلمة سر من اختياره.': "This password is shown only once. On first login they'll be asked to replace it with their own.",
    'رسالة جاهزة — انسخها (زرار النسخ فوق الرسالة على الشمال) أو ابعتها واتساب:': 'Ready message — copy it (copy button at the top of the box) or send it on WhatsApp:',
    'ابعت على واتساب': 'Send on WhatsApp',
    'تمام، خلّصت': 'Done',
    'اعمل حساب لحد': 'Create an account for someone',
    'اسمه': 'Name',
    'مثال: كريم محمود': 'e.g. Karim Mahmoud',
    'اسم الدخول (إنجليزي)': 'Username (English)',
    'حروف إنجليزي صغيرة وأرقام و . _ - بس. هو اللي هيكتبه وهو بيدخل.': 'Lowercase English letters, digits and . _ - only. This is what they type to log in.',
    'الباقة': 'Plan',
    'اعمل الحساب وطلّع كلمة السر': 'Create the account and get the password',
    'الحسابات اللي عملتها': 'Accounts you created',
    'لسه بكلمة السر المؤقتة': 'Still on the temporary password',
    'آخر دخول': 'Last login',
    'لسه مادخلش': "Hasn't logged in yet",
    'اسم الدخول لازم يكون حروف إنجليزي وأرقام و . _ - بس': 'The username must be English letters, digits and . _ - only',
    'اسم الدخول ده مستخدم قبل كده — اختار اسم تاني': 'That username is taken — choose another',
    'المشغّل بس يقدر يعمل حسابات جديدة': 'Only the platform operator can create accounts',
